...
#### Data
- MS-COCO:
    - [download](https://www2.informatik.uni-hamburg.de/wtm/software/) our preprocessed data (bounding boxes, bounding box labels, preprocessed captions), save it to `data/` and extract
    ...
    - download the pre-trained DAMSM for COCO model from [here](https://github.com/taoxugit/AttnGAN) and put the downloaded DAMSM model into `models/` and extract
